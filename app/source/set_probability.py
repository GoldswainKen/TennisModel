...
def set_outcome(final, sGames, rGames, vw, g, h):
    pOutcome = 0
...
def set_general(s, u, v=0, w=0, tb=1):
    ## calculate the probability of the current server winning
    ## a 6-game, tiebreak set, given prob. of server winning any
    ## given service point (s) or return point (u), and the current
    ## game score (v, w)
    ...
    if (v+w) == 12:
        ...
        for i in range(5): ## i = 0
            ...
            if t % 2 == 0:
                ...
                sGames = (t-1)/2
                rGames = (t-1)/2
            pOutcome = set_outcome(final, sGames, rGames, v, g, h)
            key = '6' + str(i)
        ...
        for i in range(5):
            ...
            if t % 2 == 0:
                ...
                sGames = (t-1)/2
                rGames = (t-1)/2
            pOutcome = set_outcome(final, sGames, rGames, w, (1-g), (1-h))
            key = str(i) + '6'
            outcomes[key] = pOutcome       
        ...
        if t % 2 == 0:
            ...
            sGames = (t-1)/2 + 1
            rGames = (t-1)/2
        f = set_outcome(1, sGames, rGames, v, g, h)
        if tb == 1:
            outcomes['75'] = f*g*h
